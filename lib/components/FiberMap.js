...
import RiverLayerGroup from './RiverLayerGroup'
import FiberLayerGroup from './FiberLayerGroup'
import SelectedPosition from './SelectedPosition'
import SelectedPosition2 from './SelectedPosition2'
...
class FiberMapContent extends Component {
  ...
  render(){
    ...
    const { map, rivers, fibers, selectedPosition, selectedPosition2 } = this.props

    return <div>
          <RiverLayerGroup rivers={rivers} selectedPosition={selectedPosition} map={map}/>
          ...
          <SelectedPosition selectedPosition2={selectedPosition2} map={map}/>
    </div>
  }
}
